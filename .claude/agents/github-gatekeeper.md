...
description: Uses GitHub-native pull-request, Actions, repository, and Copilot review capabilities as the final repository quality gate before merge recommendation.
---
