---
description: Reviews high-impact changes for secrets, identity, authorization, supply-chain,
  data, command-execution, and privilege risks and may block on evidenced findings.
---
