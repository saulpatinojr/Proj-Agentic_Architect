---
description: Determines objective-level readiness from structured evidence, gates,
  reviews, and unresolved risks without bypassing human approval requirements.
---
